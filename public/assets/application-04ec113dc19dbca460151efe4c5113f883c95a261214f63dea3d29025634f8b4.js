...
(function() { this.JST || (this.JST = {}); this.JST["events/_new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Events#new</h1>\n<form class="new-event-form">\n  <label>Event Name!\n    <input type="text" name="event[title]">\n  </label>\n  <label>Event Description\n    <textarea name="event[description]"></textarea>\n  </label>\n  <label>Event Start\n    <input type="datetime-local" name="event[start_time]">\n  </label>\n  <label>Event end\n    <input type="datetime-local" name="event[end_time]">\n  </label>\n  <label>Address\n    <label>Street Field 1:\n      <input type="text" name="event[street1]">\n    </label>\n    <label>Street Field 2:\n      <input type="text" name="event[street2]">\n    </label>\n    <label>City:\n      <input type="text" name="event[city]">\n    </label>\n    <label>State:\n      <input type="text" name="event[state]">\n    </label>\n    <label>Zip Code\n      <input type="text" name="event[zip_code]">\n    </label>\n\n  </label>\n\n  <button>Add a new Event!</button>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["events/_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="event-details-main">\n  <h1>',  groupEvent.escape("title") ,'</h1>\n  <h3>',  groupEvent.escape("start_time") ,' ',  groupEvent.escape("end_time") ,'</h3>\n  <div id="event-location">Google Map</div>\n  <p>',  groupEvent.escape("description") ,'</p>\n</section>\n\n<section class="event-details-sidebar">\n  <button class="rsvp-button">Join/RSVP</button>\n  <h3>',  groupEvent.attendees().length ,' Attending</h3>\n  <div id="event-attendee-profiles">Attendees</div>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/_banner"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (group.groupOrganizers().get(currentUser.id) ||  group.groupMembers().get(currentUser.id)) {; __p.push('\n');  var buttonText = "Leave" ; __p.push('\n');  var buttonData = "leave" ; __p.push('\n');  } else { ; __p.push('\n');  var buttonText = "Join" ; __p.push('\n');  var buttonData = "join" ; __p.push('\n');  } ; __p.push('\n\n<header id="group-banner" class="group">\n  I am the group splash banner.\n  Group name: ',  group.escape("title") ,'\n  <div class="splash"></div>\n  <ul class="group-banner-nav group">\n    <li><a href="/#/groups/',  group.id ,'">Home</a></li>\n    <li><a href="/#/groups/',  group.id ,'/members">Members</a></li>\n    <li><a href="/#/groups/',  group.id ,'/photos">Photos</a></li>\n  </ul>\n  <div class="group-banner-buttons">\n    ');  if (currentUser && currentUser.id === group.get("owner_id")) {; __p.push('\n      <a href="/#/groups/',  group.id ,'/events/new">Add event!<a>\n    ');  } ; __p.push('\n    <button\n      class="join-leave-button"\n      data-membership-toggle="',  buttonData ,'">\n      ',  buttonText ,'\n    </button>\n  </div>\n</header>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/_show_bottom"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section id="group-show-bottom">\n  <ul>\n    ');  group.groupEvents().forEach(function(groupEvent){ ; __p.push('\n    <li><a href="/#/groups/',  group.id ,'/events/',  groupEvent.id,'">', groupEvent.escape('title'),'</a></li>\n    ');  }) ; __p.push('\n  </ul>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/_show_top"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (group.groupOrganizers().get(currentUser.id) ||  group.groupMembers().get(currentUser.id)) {; __p.push('\n');  var buttonText = "Leave" ; __p.push('\n');  var buttonData = "leave" ; __p.push('\n');  } else { ; __p.push('\n');  var buttonText = "Join" ; __p.push('\n');  var buttonData = "join" ; __p.push('\n');  } ; __p.push('\n\n<section id="group-show-top">\n  Group description: group.description\n  <nav class="group-show-top-nav">\n    <div class="member-thumbs" data-event="all">\n      Member thumbnails here in Backbone\n    </div>\n    <button\n      class="join-leave-button"\n      data-membership-toggle="',  buttonData ,'">\n      ',  buttonText ,'\n    </button>\n  </nav>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/_sidebar_bottom"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section id="sidebar-bottom">\n  Sidebar Bottom - To be done entirely in backbone\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/_sidebar_top"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section id="sidebar-top">\n  <div class="sidebar-top-details">\n    <img src="http://placecorgi.com/200/200">\n    <a href="#"> group.zip_code Look up city by zip later</a>\n    <a href="#"> group.members.count + 1 "members"</a>\n  </div>\n\n  <div class="sidebar-top-events-links">\n    <a href="#">Upcoming Events</a>\n    <a href="#">Past Events</a>\n    <a href="#">Calendar Events</a>\n  </div>\n\n  <div class="sidebar-top-organizer">\n    <a href="#">Owner</a>\n  </div>\n\n\n  <div id="sidebar-categories">\n    tags\n  </div>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="groups-list group">\n  ');  groups.forEach(function(group){ ; __p.push('\n    <li><a href="', "/#/groups/" + group.id,'">',  group.escape("title") ,'</a></li>\n  ');  }) ; __p.push('\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Groups#new</h1>\n<form class="create-new-group">\n  <label>Group Name!\n    <input type="text" name="group[title]">\n  </label>\n  <label>Group Description\n    <textarea name="group[description]"></textarea>\n  </label>\n  <label>Group Location (Zip)\n    <input type="text" name="group[zip_code]">\n  </label>\n\n  <button>Add New Group!</button>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n  <section class="group-sidebars group">\n\n  </section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  var nav_url_a = loggedIn  ? "#" : "/users/new" ; __p.push('\n');  var nav_url_b = loggedIn ? "#" : "/session/new" ; __p.push('\n');  var nav_text_a = loggedIn ? "Profile Menu" : "Sign Up"; __p.push('\n');  var nav_text_b = loggedIn ? "Notifications" : "Log In" ; __p.push('\n\n<a href="#" class="logo"><img src="/images/rendez-zoo-logo.jpeg" alt="Rendez zoo logo"></a>\n<ul class="left-header-nav group">\n  <li><a href="#"><strong>Find</strong><small>a Rendez-Zoo Group</small></a></li>\n  <li><a href="/#/groups/new"><strong>Start</strong><small> a Rendez-Zoo group</small></a></li>\n</ul>\n\n<ul class="right-header-nav group">\n  <li><a href="',  nav_url_a ,'">',  nav_text_a ,'</a></li>\n  <li><a href="',  nav_url_b ,'">',  nav_text_b ,'</a></li>\n  <li><a href="#">Menu</a></li>\n  ');  if (loggedIn) {; __p.push('\n    <button class="log-out">Log Out</button>\n  ');  }; __p.push('\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["members/thumb"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
...
RendezZoo.Models.Event = Backbone.Model.extend({
  ...
  attendees: function(){
    if (!this._attendees) {
      this._attendees = new RendezZoo.Collections.Members({ rsvpEvent: this });
    }
